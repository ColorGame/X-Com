...
public class PathfindingUpdater : MonoBehaviour //Обновление поиска пути
{
    ...
    private void DestructibleCrate_OnAnyDestroyed(object sender, System.EventArgs e)
    {
        ...
        PathfindingMonkey.Instance.SetIsWalkableGridPosition(destructibleCrate.GetGridPosition(), true); // Сеточную позицию где взорвался ящик сделаем пригодной для хотьбы
    }
}
