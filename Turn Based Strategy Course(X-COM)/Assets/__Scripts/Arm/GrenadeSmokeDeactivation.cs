...
public class GrenadeSmokeDeactivation : MonoBehaviour // Деактивация дыма от гранаты после нескольких ХОДОВ
{
    ...
    private CoverObject _coverObject; // Объект укрытия
    ...
    private void Start()
    {
        ...
        _coverObject.SetCoverType(CoverType.Full); // Установим прикрытие полным
    ...
    private void TurnSystem_OnTurnChanged(object sender, System.EventArgs e)
    {
        ...
        if (_currentTurnNumber - _startTurnNumber == 4)
        {
            ...
            _coverObject.SetCoverType(CoverType.Half); // Установим прикрытие На половину
        }
